...
class Parser(antlr.LLkParser):
    ...
    def primary(self, arg_type):
        ...
        if False:
            ...
            pos1 = len(self.rpn) - 2
            self.rpn = (
                self.rpn[:pos0] + struct.pack("<H", pos1 - pos0) + self.rpn[pos0 + 2 :]
            )
            self.expr(arg_type)
            self.match(RP)
            ...
            if (self.LA(1) == INT_CONST) and (_tokenSet_0.member(self.LA(2))):
                ...
                self.LA(1) == INT_CONST or self.LA(1) == NAME or self.LA(1) == QUOTENAME
                ...
                if func_toku in all_funcs_by_name:
                    (opcode, min_argc, max_argc, func_type, arg_type_str) = (
                ...
                if arg_count > max_argc or arg_count < min_argc:
                    raise Exception(
                        "%d parameters for function: %s" % (arg_count, func_tok.text)
                    )
                if xcall:
