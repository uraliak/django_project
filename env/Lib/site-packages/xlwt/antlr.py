...
## <version>
def version():
    r = {"major": "2", "minor": "7", "micro": "5", "patch": "", "version": "2.7.5"}
    return r
...
class MismatchedTokenException(RecognitionException):
    ...
    def __init__(self, *args):
        ...
        if len(args) == 6:
            ...
            RecognitionException.__init__(
                self, "Mismatched Token: expecting any AST node", "<AST>", -1, -1
            )
...
class CommonToken(Token):
    ...
    def toString(self):
        ...
        if type_ == 3:
            ...
            tval = type_
        d = {"text": self.text, "type": tval, "line": self.line, "colm": self.col}
...
class TokenStreamSelector(TokenStream):
    ...
    def select(self, arg):
        ...
        if is_string_type(arg):
            ...
            return
        raise TypeError(
            "TokenStreamSelector.select requires " + "TokenStream or string argument"
        )
...
class TokenStreamBasicFilter(TokenStream):
    ...
    def discard(self, arg):
        ...
        if isinstance(arg, BitSet):
            ...
            return
        raise TypeError(
            "TokenStreamBasicFilter.discard requires" + "integer or BitSet argument"
        )
...
class TokenStreamHiddenTokenFilter(TokenStreamBasicFilter):
    ...
    def consumeFirst(self):
        ...
        p = None
        while self.hideMask.member(self.LA(1).getType()) or self.discardMask.member(
            self.LA(1).getType()
        ):
